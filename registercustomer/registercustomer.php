<?php
include "header.php";
include "registercustomermenu.php";
...
//save the customer data if the error flag is still clear
    if ($error == 0) {
        $query = "INSERT INTO bnb.customer (firstname,lastname,email,password,username) VALUES (?,?,?,?,?)";
...
<form method="POST" action="registercustomer.php">
  ...
  <p>
    ...
    <input type="username" id="username" name="username" minlength="8" maxlength="32" required> 
  </p> 
